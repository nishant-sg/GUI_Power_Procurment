...
function App() {
  const [demand, setDemand] = useState([5000,5000,5000,5000,5000,5000,5000,5000,
    ...
    <div className="App">
      ...
      <body>
        <div className="md:container max-w-screen-sm mx-auto">
          <h1 className="text-3xl text-blue-400	 font-bold underline">Power Procurement Risk Analysis Optimizer </h1>
          <br />
          <div>
            <form class=" mx-auto w-full">
              <select id="states" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full p-2.5">
              ...
              <div class="w-full flex justify-around">
                  <div class="flex items-center me-4">
                      <input id="thermal" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                      <label for="thermal" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Thermal</label>
                  </div>
                  <div class="flex items-center me-4">
                      <input id="solar" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                      <label for="solar" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Solar</label>
                  </div>
                  <div class="flex items-center me-4">
                      <input id="wind" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                      <label for="wind" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Wind</label>
                  </div>
                  <div class="flex items-center me-4">
                      <input id="hydro" type="checkbox" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                      <label for="hydro" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Hydro</label>
                  </div>
              </div>
              <br/>
                      ...
                      <div class="h-full w-full overflow-x-hidden	 overflow-y-scroll">
                        ...
                        <tbody id="table" class="!w-full">
                          {demand.map((item,index) => (
                            <tr value={item} key={item} class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                              <th scope="row" class="px-6 py-4 w-full font-medium text-gray-900 whitespace-nowrap">
                                {"t"+(index+1)}
                              </th>
              ...
              <div class="md:container md:mx-auto border-0 pt-2 flex justify-center">
                <button type="button" onClick={generateOutput} class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                  Generate Output
